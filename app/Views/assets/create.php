...
<h2 class="text-2xl font-semibold mb-6">Tambah Asset</h2>

<form action="<?= base_url('assets/store') ?>" method="post" enctype="multipart/form-data" class="mb-8 bg-white shadow-md rounded-xl p-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <select name="lokasi_id" class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500" required>
